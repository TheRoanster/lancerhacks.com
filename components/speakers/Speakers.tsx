...
export function Speakers() {
    let speakers = [ //****currently added speaker images in the team folder, I'd suggest making a new speaker folder in the future!!!, but for now just add the image there
        ...
        ["Neha", "Neha Chourasia","Neha Chourasia leads the Engineering team for the Infectious Disease program at Chan Zuckerberg Initiative, where she spearheads the development of innovative tools and technologies to enhance the detection, identification, and tracking of infectious diseases. With a background at Oracle, Neha brings extensive experience in building core software components and frameworks, which have been instrumental in optimizing business processes for numerous customers. Beyond her professional endeavors, Neha is deeply committed to volunteering and practicing yoga. She shares her practice with a small group as part of her holistic lifestyle.", "https://www.linkedin.com/in/neha-chourasia-87170612?challengeId=AQGrkj_8f5396AAAAY33UjEbGsNG81Pm0dMXrIj8ptwPcclWXdGL0fjraXQ2A5KPo4KEUxkY4OLJuvCxO6kaXssaVZmvpiWDPA&submissionId=188cc9cb-117b-b817-e2c0-80c7e0d6284c&challengeSource=AgEEyCQNB-VAcQAAAY33Uju530ms2oWHLRh3lwOXDTX1FtVgbw-oK2NwNP67_rc&challegeType=AgG2M6_JMiU30gAAAY33Uju90O-AjCcfbaxjByVC-ZqCJo4QFmMVNss&memberId=AgHsRJpHeKNbjAAAAY33UjvAjXB4KRdGRyzgRuqQgRQi5tQ&recognizeDevice=AgEH7IO9ESOnnQAAAY33UjvDzsIwL06PqE5LfMIs-uyKLIAr0krx"],
    ]
