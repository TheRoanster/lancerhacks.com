    ...
    <section className={styles.container} id="home">
      <div className={styles.background}>
        <div className={styles.inner_container} style={{opacity:1-(scroll/height), display: scroll>height?'none':'flex'}}>
          ...
          <a className={styles.sign_up} href="https://docs.google.com/forms/d/e/1FAIpQLSfAoKNpubRwHacBMuQQMUY39z93nqLtRmcYUxlEtCqd-QC9VA/viewform?usp=sf_link">Sign Up</a>
        </div>
      </div>
    </section>
  )
